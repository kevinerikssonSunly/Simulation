...
def calculate_break_even_price_1(total_wind, wind_PaP, total_pv, pv_PaP, bess_annual_payments, excess_energy, excess_energy_vwap, missing_energy, missing_energy_price, baseload):
