...
def simulate_dispatch(
    ...
    for year in years:
        ...
        brake_even_3 = calculate_break_even_price_3(wind_prod_year.sum(), wind_price, solar_prod_year.sum(), solar_price, total_storage_cost, excess_energy, result["Missing energy, MWh"], missing_energy_price, baseload * len(wind_prod_year))
