...
def compile_result(
    ...
    return {
        ...
        "Res share in demand, %": round((m["produced_total"] / expected_baseload) * 100) if expected_baseload > 0 and pd.notna(
            m["produced_total"]) else 0.0,
        "Nr of green demand hours, h": m["hours_met"],
        "Nr of hours, h": hours,
        ...
        "Wind in demand, MWh": round(wind_baseload),
        "Solar in demand, MWh": round(solar_baseload),
